...
namespace CodeFirstMembership
{
    public static class CodeFirstSecurity
    {
        private static Dictionary<string, Guid> _userNameToId = new Dictionary<string, Guid>();
        ...
        public static Guid CurrentUserId
        {
            ...
            {
                Guid userId;
                if (!_userNameToId.ContainsKey(CurrentUserName))
                {
                    userId = GetUserId(CurrentUserName);
                    if (userId != Guid.Empty)
                        _userNameToId.Add(CurrentUserName, userId);
                }
                else
                    userId = _userNameToId[CurrentUserName];
